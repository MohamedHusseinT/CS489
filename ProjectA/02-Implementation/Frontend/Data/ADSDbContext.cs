...
namespace ADSDentalSurgeriesWebApp.Data
{
    public class ADSDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Unique constraints
            modelBuilder.Entity<Surgery>().HasIndex(s => s.SurgeryNumber).IsUnique();
            modelBuilder.Entity<Patient>().HasIndex(p => p.PatientNumber).IsUnique();
            modelBuilder.Entity<Dentist>().HasIndex(d => d.DentistNumber).IsUnique();
            modelBuilder.Entity<Appointment>().HasIndex(a => a.AppointmentNumber).IsUnique();
            ...
            modelBuilder.Entity<Surgery>().HasData(
                new Surgery { SurgeryId = 1, SurgeryNumber = "S10", Name = "Phoenix Central Dental", AddressId = 1, PhoneNumber = "(602) 555-0101" },
                new Surgery { SurgeryId = 2, SurgeryNumber = "S13", Name = "Phoenix North Dental", AddressId = 2, PhoneNumber = "(602) 555-0102" },
                new Surgery { SurgeryId = 3, SurgeryNumber = "S15", Name = "Phoenix South Dental", AddressId = 3, PhoneNumber = "(602) 555-0103" }
            );
