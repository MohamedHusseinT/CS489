...
namespace ADSDentalSurgeries.Data
{
    /// <summary>
    ...
    public class ADSDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Composite unique constraint for UserRole
            modelBuilder.Entity<UserRole>()
        ...
        private void SeedData(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Role>().HasData(
                new Role { RoleId = 1, RoleName = "Office Manager", Description = "Manages appointments and system administration" },
                new Role { RoleId = 2, RoleName = "Dentist", Description = "Provides dental services to patients" },
                new Role { RoleId = 3, RoleName = "Receptionist", Description = "Handles patient registration and appointment scheduling" }
            );

            // Seed Users
            modelBuilder.Entity<User>().HasData(
                new User { UserId = 1, Username = "admin", Email = "admin@ads.com", PasswordHash = "hashed_password_1", FirstName = "System", LastName = "Administrator" },
                new User { UserId = 2, Username = "tony.smith", Email = "tony.smith@ads.com", PasswordHash = "hashed_password_2", FirstName = "Tony", LastName = "Smith" },
                new User { UserId = 3, Username = "helen.pearson", Email = "helen.pearson@ads.com", PasswordHash = "hashed_password_3", FirstName = "Helen", LastName = "Pearson" }
            );

            // Seed UserRoles
            modelBuilder.Entity<UserRole>().HasData(
                new UserRole { UserRoleId = 1, UserId = 1, RoleId = 1 }, // admin -> Office Manager
